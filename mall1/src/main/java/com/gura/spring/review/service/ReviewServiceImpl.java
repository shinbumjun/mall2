...
import com.gura.spring.review.dao.ReviewCommentDao;
import com.gura.spring.review.dao.ReviewDao;
...
public class ReviewServiceImpl implements ReviewService {
	...
	public void getDetail(HttpServletRequest request) {
		...
		*/
		...
		// reviewDto 객체를 메소드의 인자로 전달해서 새로운reviewDto 객체의 참조값을 얻어온다. 
	...
	public void deleteComment(HttpServletRequest request) {
		...
		//삭제할 댓글 정보를 읽어와서 
		ReviewCommentDto dto=reviewCommentDao.getData(num);
		String id=(String)request.getSession().getAttribute("id");
